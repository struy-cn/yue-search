...
touch public/wechat-page/2021~2022.html && curl -s "https://mp.weixin.qq.com/s/INAneQU2gGict0ikdAED6w?f=json" | jq --raw-output .content_noencode >public/wechat-page/2021~2022.html
